...
Given('I am testing extended debugging on webpage', async function() {
    await this.browser.url('https://www.saucedemo.com/');
    await this.browser.pause(2000);
});

Then('I check for sauce:network logs', async function () {
...
Then('I check for sauce:metrics logs', async function () {
...
Then('I check for sauce:hello custom commands', async function () {
